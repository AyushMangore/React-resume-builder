...
// preview of the resume will be generated side by side
...
function ResumePreview(props){
    ...
    const rvContact=(key, valToAppend)=>{
        ...
        //  if contact object contains the key of the even then extract the value else empty string
    ...
    const rvEducation=(key, valToAppend)=>{
        if(props.educationSection){
            //  if education object contains the key of the even then extract the value else empty string
        ...
        return (
            <div className={props.skinCd + " resume-preview "}>
                <div className={'name-section'}>
                    {/* updating all the data according to the information passed by contact component */}
